      ...
      <div className="sticky lg:static top-0 navbar bg-base-100 min-h-0 flex-shrink-0 justify-between z-20 shadow-md shadow-secondary px-0 sm:px-2">
        <div className="navbar-start w-auto lg:w-1/2">
          ...
          <Link href="/" passHref className="hidden lg:flex items-center gap-2 ml-4 mr-6">
            ...
            <div className="flex flex-col">
              ...
              <span className="text-xs">xChain dev stack</span>
            </div>
          </Link>
        ...
        <div className="navbar-end flex-grow mr-4 space-x-4">
          ...
          <div className="flex flex-col items-center justify-center">
            <>
              <span>{footyTokenBalance?.formatted}</span>
              <span className="text-[0.8em] font-bold ml-1 text-green-600">{footyTokenBalance?.symbol}</span>
            </>
          </div>
        </div>
      </div>
